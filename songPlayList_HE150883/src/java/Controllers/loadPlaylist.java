 ...
 * @author smileymask
 */
public class loadPlaylist extends HttpServlet {
DAO dao;
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try ( PrintWriter out = response.getWriter()) {
            ...
            out.println("<html>");
            out.println("<head>");
            out.println("<title>Servlet loadPlaylist</title>");            
            out.println("</head>");
            out.println("<body>");
            out.println("<h1>Servlet loadPlaylist at " + request.getContextPath() + "</h1>");
            out.println("</body>");
            out.println("</html>");
        }
    }
...
//        request.getRequestDispatcher("view/User/playList.jsp").forward(request, response);   
        ...
        request.getRequestDispatcher("view/User/playList.jsp").forward(request, response);
         ...
         request.setAttribute("LoadPlaylist", "LoadPlaylist");
