        ...
        <c:if test="${requestScope.DAO != null}">
            <div class="container">
                ...
                <div class="box-container">
                    ...
                    <c:forEach items= "${requestScope.DAO.songList}" var= "song"   begin="0" end="6">
                ...
                <div class="box-container">
                    <h1>New Song</h1>
                    <!--                <h1 class="heading"> music playlist </h1>-->
                    <c:forEach items= "${newSong}" var= "song"   begin="0" end="6" >
                 ...
                 <div class="box-container">
                    <h1>For you</h1>
                    <!--                <h1 class="heading"> music playlist </h1>-->
                    <c:forEach items= "${recomendSong}" var= "song"  begin="0" end="6"  >
